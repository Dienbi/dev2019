...
//        ;
//    }
public function chambreListByfoyer()
    {
        return $this->createQueryBuilder('b')
            ->join('b.foyer', 'a') // Assuming the association between Book and Author is named 'author'
            ->orderBy('a.nom', 'ASC') // Replace 'authorName' with the actual property of Author representing the author's name
            ->getQuery()
            ->getResult();
    }
}
